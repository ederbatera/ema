  ...
  const Container = () => {
    ...
    return (
      <section className="place-items-center mt-3">
        ...
        <div className="flex flex-wrap gap-3 mb-6 p-4 rounded-xl w-full max-w-screen-xl justify-around
      ...
      dark:bg-black border-0 dark:text-blue-gray-200 dark:shadow-blue-gray-900">
          ...
          <div className="flex flex-col items-center border rounded-xl p-3 gap-y-2 md:min-w-[10rem] place-items-center min-w-full">
            <div>
