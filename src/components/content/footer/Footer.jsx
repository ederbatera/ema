...
const Footer = () => {
    return (
        <footer className="flex w-full flex-col flex-wrap items-center justify-center gap-y-6 gap-x-12 border-t  py-6 text-center
            ...
            <Typography as="a" href="https://www.facebook.com/emaagudos" 
                className="opacity-80 transition-opacity hover:opacity-100 -mt-7 text-blue-700 flex flex-row gap-x-2">
